<template>
  <div class="relative w-full rounded-full">
    ...
    <NuxtLink class="relative z-10 block text-center text-3xl sm:text-8xl border-8 sm:border-20 border-red-500 bg-black text-white rounded-full p-8 sm:p-20 hover:bg-red-500 hover:text-black hover:no-underline mix-blend-difference transition-all duration-700" to="/music">
      <slot />
    </NuxtLink>
  </div>
</template>
