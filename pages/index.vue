<template>
  <div>
    ...
    <section class="content1 flex flex-col justify-center gap-24 w-screen min-h-screen p-4 lg:p-40 text-2xl lg:text-6xl text-black bg-white prose prose-p:leading-normal text-pretty">
      <div class="container">
        <p>
    ...
    <section class="content2 flex flex-col justify-center gap-24 w-screen min-h-screen p-4 lg:p-40 text-2xl lg:text-6xl text-white bg-black prose prose-p:leading-normal text-pretty">
      <div class="container">
        <p>
